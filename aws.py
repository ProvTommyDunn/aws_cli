...
idpentryurl = 'https://portal.provaws.com/aws'
...
formsoup = BeautifulSoup(formresponse.text.encode('utf-8').decode('utf-8'))
payload = {}
...
soup = BeautifulSoup(response.text.encode('utf-8').decode('utf-8'))
assertion = ''
